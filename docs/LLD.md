...
| 2 — API | POST/GET /v1/scenes, webhook, keys, compose (ARM) + worker image (x86 CUDA) | happy path + honest-failure path (10 s clip → `failed`/insufficient coverage) | done; 20 tests incl. both paths |
